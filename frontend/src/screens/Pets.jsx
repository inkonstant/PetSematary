...
export default function Pets() {
  ...
  const filteredPets = pets.filter((p) => {
    ...
    return p.name.toLowerCase().includes(lower) || p.species.toLowerCase().includes(lower);
  });
              ...
              <tbody>
                {Object.entries(details).map(([key, value]) => (
                  <tr key={key}>
                    ...
                    <td>
                      {value === '[REDACTED]' ? <span className="redacted">[REDACTED]</span> : value === null || value === '' ? '-' : String(value)}
                    </td>
                  </tr>
                ))}
              </tbody>
